          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                ...
                <span class="back" @click="move('/courses')"
                  ...
                  <strong class="back">Courses</strong>
                </span>
            ...
            <div class="row mx-md-3">
              <div class="col-12 mt-3 col-md-6">
                <label for="images"
                  ><strong>Upload Course Images</strong> (Two Images)</label
                >
                <br />
                <input
                  type="file"
                ...
                />
                <span
                  v-for="(item, ind) in courseImages
                    ? courseImages
                    : course.courseImages"
                  :key="ind"
                >
                  <img
                    class="ml-3 mr-3"
                    width="30px"
                    :src="courseImages ? item : APIServerImage + item"
                    alt=""
                  />
                </span>
              </div>
              <div class="col-12 mt-3 col-md-6">
                ...
                <img
                  ...
                  :src="
                    companyLogoImage
                      ? companyLogoImage
                      : APIServerImage + course.companyLogoImage
                  "
                  alt=""
                />
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 col-md-3">
                      <div class="form-group">
                        ...
                        <select
                          v-model="course.organizedTrainerUserId"
                          class="form-control"
                          required
                        >
                          <option
  ...
  methods: {
    ...
    getAllCategories() {
      ...
      axios
        ...
        .catch((e) => {
          console.log("admin/getCategories API failed", e);
        });
      this.loading = false;
    },
    move(to) {
    ...
    changeToLocalImages(images) {
      ...
      this.courseImages = imgArr;
    },
    changeToLocalImage(image) {
      this.companyLogoImage = window.URL.createObjectURL(image);
      this.course.companyLogoImage = image;
    },
    ...
    saveNewCourse() {
      ...
      newCourse.append("activeStatus", this.course.activeStatus ? true : false);
...
// console.log(this.addresses[0])
      ...
      //   console.log(item)
      //   newCourse.append("locations", item)
      // })
      ...
      newCourse.append("companyLogoImage", this.course.companyLogoImage);
      newCourse.append("categoryId", this.course.categoryId);
      newCourse.append(
        "organizedTrainerUserId",
        this.course.organizedTrainerUserId
      );

      this.course.courseImages.forEach((file) => {
        newCourse.append("courseImages", file);
      });
console.log('locations',...newCourse)

      axios
        .post("admin/createCourse", newCourse, {
          headers: {
        ...
        .catch((e) => {
          console.log("admin/createCourse API failed", e);
          this.openNotificationWithIcon(
            "error",
            response.data,
            "bottomRight"
